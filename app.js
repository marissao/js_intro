...
var peanutsGang = ['Linus', 'Snoopy', 'Charlie Brown', 'Lucy', 'Woodstock'];
...
var originalBalance = 8000
var deposit = 1000
var newBalance = originalBalance + deposit;
...
var purchaseBitcoin = 3000
var newBalance2 = newBalance - purchaseBitcoin;
...
var Bitcoins = 2;
Bitcoins++;
var updatedBitcoins = Bitcoins
console.log(updatedBitcoins)
...
var evenNumber = newBalance2 % 2;
console.log(evenNumber)
var newSavingsBalance = newBalance2 + 500
...
var taxes = 500 * 0.3;
console.log(taxes)
var adjustedSavingsBalance = newSavingsBalance - taxes;
console.log(adjustedSavingsBalance)
...
var annualInterest = adjustedSavingsBalance * interestRate ;
var firstQuarterInterest = annualInterest / 4;
console.log(firstQuarterInterest)
...
Console.log the new Bitcoin quantity amount.*/
 ...
 Bitcoins--;
 var afterHackBitcoins = Bitcoins;
 console.log(afterHackBitcoins)